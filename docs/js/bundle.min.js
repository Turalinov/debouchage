...
eval("const countries = __webpack_require__(/*! ./countries.json */ \"./node_modules/countries-phone-masks/src/countries.json\")\n\nmodule.exports = countries\n\n\n//# sourceURL=webpack://debouchage/./node_modules/countries-phone-masks/src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/video.js */ \"./src/js/modules/video.js\");\n/* harmony import */ var _modules_equipment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/equipment.js */ \"./src/js/modules/equipment.js\");\n/* harmony import */ var _modules_accordion_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/accordion.js */ \"./src/js/modules/accordion.js\");\n/* harmony import */ var _modules_contacts_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/contacts.js */ \"./src/js/modules/contacts.js\");\n/* harmony import */ var _modules_masks_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/masks.js */ \"./src/js/modules/masks.js\");\n/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/menu.js */ \"./src/js/modules/menu.js\");\n/* harmony import */ var _modules_types_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/types.js */ \"./src/js/modules/types.js\");\n/* harmony import */ var _modules_search_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/search.js */ \"./src/js/modules/search.js\");\n/* harmony import */ var _modules_header_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/header.js */ \"./src/js/modules/header.js\");\n/* harmony import */ var _modules_toggle_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/toggle.js */ \"./src/js/modules/toggle.js\");\n/* harmony import */ var _modules_wind_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/wind.js */ \"./src/js/modules/wind.js\");\n/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/modal.js */ \"./src/js/modules/modal.js\");\n/* harmony import */ var _modules_insp_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/insp.js */ \"./src/js/modules/insp.js\");\n/* harmony import */ var _modules_reviews_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/reviews.js */ \"./src/js/modules/reviews.js\");\n/* harmony import */ var _modules_partners_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/partners.js */ \"./src/js/modules/partners.js\");\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n(0,_modules_video_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n(0,_modules_equipment_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n(0,_modules_accordion_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n(0,_modules_contacts_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n(0,_modules_masks_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n(0,_modules_menu_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])();\n(0,_modules_insp_js__WEBPACK_IMPORTED_MODULE_12__[\"default\"])();\n(0,_modules_types_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\n(0,_modules_search_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\n(0,_modules_header_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\n(0,_modules_toggle_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"])();\n(0,_modules_wind_js__WEBPACK_IMPORTED_MODULE_10__[\"default\"])();\n(0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_11__[\"default\"])();\n(0,_modules_reviews_js__WEBPACK_IMPORTED_MODULE_13__[\"default\"])();\n(0,_modules_partners_js__WEBPACK_IMPORTED_MODULE_14__[\"default\"])();\n\n\n\n//# sourceURL=webpack://debouchage/./src/js/bundle.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ header)\n/* harmony export */ });\nfunction header() {\n\tlet last_known_scroll_position = 0;\n\tlet ticking = false;\n\tlet header = document.querySelector('.headerr__bottom-wrap');\n\tfunction doSomething(scroll_pos) {\n\t\t// Делаем что-нибудь с позицией скролла\n\n\t\tif (scroll_pos > 5) {\n\t\t\theader.classList.add('active');\n\t\t} else {\n\t\t\theader.classList.remove('active');\n\t\t}\n\t}\n\n\twindow.addEventListener('scroll', function(e) {\n\t\tlast_known_scroll_position = window.scrollY;\n\n\t\tif (!ticking) {\n\t\t\twindow.requestAnimationFrame(function() {\n\t\t\t\tdoSomething(last_known_scroll_position);\n\t\t\t\tticking = false;\n\t\t\t});\n\n\t\t\tticking = true;\n\t\t}\n\t});\n}\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/header.js?");

/***/ }),

/***/ "./src/js/modules/insp.js":
/*!********************************!*\
  !*** ./src/js/modules/insp.js ***!
  \********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ insp)\n/* harmony export */ });\nfunction insp() {\n  console.log('inspection')\n\n  //скрипт для переключения вариантов\n  const inspections = document.querySelectorAll('.inspection');\n\n\n  if (inspections) {\n\n  const breakpoint = window.matchMedia('(min-width: 769px)');\n\n  // отслеживаем экземпляр swiper для последующего уничтожения\n  let inspectionSwiper = [];\n  let objInspectionSwiper;\n\n\n     //функция проверки\n    const breakpointChecker = function () {\n\n      if (breakpoint.matches === true) {\n        console.log('тут показывается слайдер');\n        /* окно просмотра имеет ширину больше 768px пикселей */\n        return enableSwiper();\n\n      } else {\n\n        console.log('а тут не показывается слайдер');\n        /* окно просмотра имеет ширину меньше 768px пикселей */\n\n        // очищаем старые экземпляры и встроенные стили, когда они доступны\n\n        if (inspectionSwiper !== undefined) {\n          console.log(inspectionSwiper);\n          inspectionSwiper.forEach(inspectionswiper => {\n            inspectionswiper.destroy(true, true);\n          })\n        }\n\n\n        // или / и ничего не делать\n        return;\n      }\n    }\n\n    const enableSwiper = function () {\n\n      const containers = document.querySelectorAll('.inspection__slider');\n\n      containers.forEach((container, index) => {\n\n\n        objInspectionSwiper = new Swiper(container.querySelector('.inspection__swiper'), {\n        // Стрелки\n        // navigation: {\n        //   nextEl: '.doctors__button-next',\n        //   prevEl: '.doctors__button-prev',\n        // },\n        // количество слайдов на просмотр (слайды, видимые одновременно в контейнере слайдера).\n        slidesPerView: 1,\n        // slidesPerView: 'auto', //отключение функционала если слайдов меньше чем указано в slidesPerView\n        // whatchOverflow: true,\n        // grabCursor: true,\n        //оступ между слайдами\n        spaceBetween: 20,\n\n        grabCursor: true,\n\n        // autoHeight: true,\n\n        // slidesOffsetBefore: 8,\n        // slidesOffsetAfter: 8,\n        //количество пролистываемых слайдов\n        // slidesPerGroup: 1, //изменяет фракцию\n\n\n        scrollbar: {\n          el: container.querySelector('.inspection__card-scrollbar'),\n          hide: false, // By default, the scrollbar will be hidden when not scrolling\n          draggable: true, // Enable draggable scrollbar\n        },\n\n        breakpoints: {\n          //если ширина больше или равно 320\n          //when window width is >= 320px\n          // 320: {\n          //   // slidesPerView: 2,\n          //   // spaceBetween: 20\n          // },\n          //если ширина больше или равно 768\n          // when window width is >= 768px\n          768: {\n            slidesPerView: 1,\n            spaceBetween: 20\n          },\n          //если ширина больше или равно 992\n          // when window width is >= 992px\n          992: {\n            slidesPerView: 2,\n            spaceBetween: 20\n          },\n          //если ширина больше или равно 1440\n          // when window width is >= 1440px\n\n          1300: {\n            slidesPerView: 2,\n            spaceBetween: 20\n          },\n          1500: {\n            slidesPerView: 3,\n            spaceBetween: 20\n          },\n          1920: {\n            slidesPerView: 3,\n            spaceBetween: 20\n          }\n\n        }\n\n\n      });\n\n\n\n\n\n\n\n      inspectionSwiper.push(objInspectionSwiper);\n\n      })\n\n    }\n\n    // следим за изменениями размера области просмотра\n    breakpoint.addListener(breakpointChecker);\n\n    //старт\n    breakpointChecker();\n\n\n\n\n\n\n\n  }\n}\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/insp.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ masks)\n/* harmony export */ });\n/* harmony import */ var countries_phone_masks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! countries-phone-masks */ \"./node_modules/countries-phone-masks/src/index.js\");\n/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imask */ \"./node_modules/imask/esm/index.js\");\n\n\n\n\n\nfunction masks() {\n\n  const regionsList = document.querySelector('.custom_phone-select-list');\n  if (regionsList) {\n\n\n\n    countries_phone_masks__WEBPACK_IMPORTED_MODULE_0__.sort(function(a, b) {\n      if (a.iso < b.iso) {\n        return -1;\n      }\n      if (a.iso > b.iso) {\n        return 1;\n      }\n      // если имена равны\n      return 0;\n    });\n\n\n    countries_phone_masks__WEBPACK_IMPORTED_MODULE_0__.forEach(countries => {\n\n      const iso = countries['iso'];\n      const code = countries['code'];\n\n      let mask = countries['mask'];\n\n      if (Array.isArray(mask)) {\n        mask = countries['mask'][0];\n      }\n\n      mask = mask.replace(/#/g, '0');\n      mask =  `${code} ${mask}`;\n\n\n      // создаем див\n      var regionItem = document.createElement(\"div\");\n      regionItem.innerHTML = iso;\n      regionItem.classList.add('custom_phone-select-list-item')\n      regionItem.setAttribute('data-mask', mask);\n      regionsList.append(regionItem);\n    });\n\n\n\n\n    const select = document.querySelector('.custom_phone-select-list-wrap');\n    const activeSelectValue = document.querySelector('.custom_phone-select-value');\n    const selectItems = select.querySelectorAll('.custom_phone-select-list-item');\n    const icon = document.querySelector('.custom_phone-select-wrap');\n    const input = document.querySelector('.js-phone');\n\n\n    let phoneMask;\n\n    setMask(input, '+33 (000) 000-000');\n\n\n\n     function setMask(input, mask) {\n            // Создаем новый экземпляр IMask с заданной маской\n            phoneMask = (0,imask__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(input, {\n                mask: mask,\n                lazy: false, // Не ждем ввода пользователя\n                // placeholderChar: '0', // Используем \"0\" вместо \"#\"\n            });\n        }\n\n    function updateMask(mask) {\n        // Обновляем опции маски\n        phoneMask.updateOptions({\n            mask: mask,\n        });\n    }\n\n\n    icon.addEventListener('click', function() {\n      select.classList.toggle('active');\n    })\n\n\n    selectItems.forEach(selectItem => {\n      selectItem.addEventListener('click', (e)=> {\n        if (select.classList.contains('active')) {\n            select.classList.remove('active');\n        }\n\n        activeSelectValue.innerHTML = selectItem.innerHTML;\n\n        const current = e.currentTarget;\n        const currentMask = current.dataset.mask;\n\n        //назначить маску\n       updateMask(currentMask);\n\n\n\n\n      })\n    });\n\n    input.addEventListener('input', () => {\n           // Получение значения из текстового поля\n        var inputValue = input.value;\n\n\n        // Получение \"размаскированного\" значения с учетом текущей маски\n        // var unmaskedValue = phoneMask.unmaskedValue();\n\n        console.log({\n          inputValue\n        });\n    })\n\n\n\n\n  }\n\n\n}\n\n\n//ПРОДОЛЖИТЬ МАСКУ ДАТЫ\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/masks.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ modal)\n/* harmony export */ });\nfunction modal() {\n  console.log('modal');\n\n  const buttons = document.querySelectorAll('.call-modal-second');\n\n  if (buttons && buttons.length > 0) {\n\n    const callModal = document.querySelector('#modal-second');\n    const callModalInner = callModal.querySelector('.modal__inner');\n\n    console.log({callModal});\n\n    buttons.forEach(button => {\n      button.addEventListener('click', (e) => {\n        const currentButton = e.currentTarget;\n        const text = currentButton.getAttribute('date-text');\n        console.log({text});\n        callModalInner.innerHTML = text;\n\n        if (!(callModal.classList.contains('open'))) {\n          callModal.classList.add('open');\n        }\n\n      })\n    })\n  }\n\n\n\n  const modalCloseButtons = document.querySelectorAll('.modal__close');\n\n  if (modalCloseButtons && modalCloseButtons.length > 0) {\n    modalCloseButtons.forEach(modalCloseButton => {\n      modalCloseButton.addEventListener('click', (e) => {\n        const currentCloseButton = e.currentTarget;\n        const parent = currentCloseButton.closest('.modal');\n        parent.classList.remove('open');\n      })\n    })\n  }\n\n\n}\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/modal.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ partners)\n/* harmony export */ });\nfunction partners() {\n  console.log('partners');\n\n  const partners__slider = document.querySelectorAll('.partners__slider');\n\n  if (partners__slider) {\n\n      const partnerSwiper = new Swiper('.partners__slider', {\n        grabCursor: true,\n        slidesPerView: 'auto',\n        spaceBetween: 20,\n        loop: false,\n\n        // autoplay: {\n        //   delay: 3000,\n        //   disableOnInteraction: false,\n        // },\n\n        slidesPerGroup: 1,\n        //изменяет фракцию\n\n        //стартовый слайд\n        initialSlide: 0,\n\n        breakpoints: {\n          //если ширина больше или равно 320\n          //when window width is >= 320px\n          // 320: {\n          //   // slidesPerView: 2,\n          //   // spaceBetween: 20\n          // },\n          //если ширина больше или равно 768\n          // when window width is >= 768px\n          // 768: {\n          //   slidesPerView: 1,\n          //   spaceBetween: 0\n          // },\n          //если ширина больше или равно 992\n          // when window width is >= 992px\n          // 992: {\n          //   slidesPerView: 2,\n          //   spaceBetween: 40\n          // },\n          //если ширина больше или равно 1440\n          // when window width is >= 1440px\n\n        }\n\n\n      });\n\n  }\n}\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/partners.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ toggle)\n/* harmony export */ });\nfunction toggle()\n{\n  console.log('toggle');\n\n  const menuToggle = document.querySelector('.toggle');\n\n  if (menuToggle) {\n    const menu = document.querySelector('.main-headerr');\n    const body = document.querySelector('body')\n\n    menuToggle.addEventListener('click', (e) => {\n      e.preventDefault();\n      menu.classList.toggle('active')\n      body.classList.toggle('lock')\n    })\n  }\n}\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/toggle.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ types)\n/* harmony export */ });\n\n\nfunction types () {\n  console.log(\"types\");\n\n  const types = document.querySelector('.types');\n\n  if ( types ) {\n\n\n    function deleteActiveClassNodes(nodes) {\n      nodes.forEach(node => {\n        node.classList.remove('active');\n      })\n    }\n\n    function addActiveClassById(nodes, id) {\n      nodes[id].classList.add('active');\n    }\n\n\n\n    // list\n    const types__lists_d = types.querySelector('.types__list--desktop');\n    const types__lists_m = types.querySelector('.types__list--mobile');\n\n    console.log({types__lists_d});\n\n\n    // list items\n    const types__items_d = types__lists_d.querySelectorAll('.types__item');\n\n    const types__items_m = types__lists_m.querySelectorAll('.types__item');\n\n    const inspection__items = document.querySelectorAll('.inspection__item');\n\n    // content\n    const types__contents = types.querySelectorAll('.types__content');\n\n    // image\n    const types__images = types.querySelectorAll('.types__image');\n\n    listenerTypesItems(types__items_d)\n    listenerTypesItems(types__items_m)\n\n    function listenerTypesItems(types__items) {\n\n      if (types__items) {\n\n          types__items.forEach((types__item, index) => {\n\n            const types__links = types__item.querySelector('.types__link');\n\n            types__links.addEventListener('click', (e) => {\n              e.preventDefault();\n\n              deleteActiveClassNodes(types__items_d);\n              addActiveClassById(types__items_d, index);\n              deleteActiveClassNodes(types__items_m);\n              addActiveClassById(types__items_m, index);\n              deleteActiveClassNodes(types__contents);\n              addActiveClassById(types__contents, index);\n              deleteActiveClassNodes(types__images);\n              addActiveClassById(types__images, index);\n              deleteActiveClassNodes(inspection__items);\n              addActiveClassById(inspection__items, index);\n            })\n          })\n\n        }\n    }\n\n\n\n\n\n\n  }\n\n\n}\n\n\n//# sourceURL=webpack://debouchage/./src/js/modules/types.js?");
